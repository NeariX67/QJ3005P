...
public class Interface {
	...
	static ObservableList<String> Serialports = FXCollections.observableArrayList();
	...
	private void initialize() {
			...
			public void actionPerformed(ActionEvent arg0) {
				for (int i = 0; i < serList.length; i++) {
					if (Serialports.size() > 0) {
						if (Serialports.get(i).toString() == comboBox.getSelectedItem().toString()) {
							index = i;
							serPort = serList[i];
						}
					}
		...
		JLabel lbSpannunngA = new JLabel("0.00");
